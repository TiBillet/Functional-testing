...
import {getEnv, connectionAdmin, userAgentString} from '../../mesModules/commun.js'
...
test.describe("Contexte, catégories :", () => {
  ...
  test("Création d'une catégories avec trois espaces.", async () => {
    ...
    await pageAdmin.waitForURL(urlRoot + '/adminstaff/APIcashless/categorie/')

    // Clique sur "Ajouter article"
    await pageAdmin.locator('text=Ajouter Catégorie d\'articles').click()
    await pageAdmin.waitForURL(urlRoot + '/adminstaff/APIcashless/categorie/add/')
  ...
  test("Création de 3 artiles comprenant la catégorie avec 3 espaces.", async () => {
    ...
    await pageAdmin.waitForURL(urlRoot + '/adminstaff/APIcashless/articles/')
    // Ajouter article
    await pageAdmin.locator('text=Ajouter article').click();
    await pageAdmin.waitForURL(urlRoot + '/adminstaff/APIcashless/articles/add/')
  ...
  test('Ajout des 3 articles au point de vente "Bar 1".', async () => {
    ...
    await pageAdmin.locator('input[name="_save"]').click();
    await pageAdmin.waitForURL(urlRoot + '/adminstaff/APIcashless/pointdevente/')
